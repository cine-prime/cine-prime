...
export class ListSessionsController {
    async index(req: Request, res: Response) {
        ...
        const session = await listSessionsService.execute(req, res);
...
export class FindSessionByIdController {
    async find(req: Request, res: Response) {
        ...
        const session = await findSessionByIdService.execute({ id: Number(id) }, req, res);
...
export class DeleteSessionController {
    async delete(req: Request, res: Response) {
        ...
        const session = await deleteSessionService.execute(req, res);
