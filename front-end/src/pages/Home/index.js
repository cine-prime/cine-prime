...
export default function Home(props) {
  ...
  return (
    <MainContainer>
      ...
      <Button variant='success' text='Sobre a equipe Cine Prime' onClick={() => handleSubmit()} />

      {authToken? 
        <Button text={`Olá ${userEmail}`} />
        :
        <>
        <Link to='/cadastro'><Button text='Cadastrar-se' /></Link>
        <Link to='/login'><Button text='Entrar' /></Link>
        </>}
